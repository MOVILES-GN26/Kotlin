...
class ProductRepository(private val context: Context) {
    ...
    suspend fun saveDraftAdvanced(
            ...
            try {
                FileOutputStream(file).use { out ->
                    if (imageUri != null) {
                        ...
                        // [C] REQUERIMIENTO: Caching - Miniatura en memoria
                        val thumb = Bitmap.createScaledBitmap(imageBitmap, 150, 150, true)
        ...
        withContext(Dispatchers.IO) {
            // [B] ESTRATEGIA: Local Storage Management (Límite de 10)
